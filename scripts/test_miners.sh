...
Dhpcd tx request create-request-record aea7cfd3-1e63-4f90-9311-1c32dacf41cb 0xa0fb4b5e51e55405e5b9e6c5defe381409e99204a3a23b5ef994e3951ded26e0 ethereum `Dhpcd keys show dapp -a` 0xc8372ff584f621041b6B107050a16c4EcAa57F5A `Dhpcd keys show oracle -a` 12345678 --from oracle -y --log_level error  --gas 500237
